...
app_showcase(snapps_urls()[1:6], snapps_urls("img")[1:6], snapps_titles("title")[1:6], snapps_titles("sub")[1:6], labs[1:6], new_window = FALSE)
```
...
idx <- c(7:10, 16, 21:23)
app_showcase(snapps_urls()[idx], snapps_urls("img")[idx], snapps_titles("title")[idx], snapps_titles("sub")[idx], labs[idx], new_window = FALSE)
```
