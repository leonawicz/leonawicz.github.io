...
The package of most use and interest to a general audience working with snapdata is `snapfuns`.
...
This removes the need to for a user to interact directly with apps hosted on [shinyapps.io](http://shinyapps.io/)
